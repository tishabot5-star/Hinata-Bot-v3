...
module.exports = {
        ...
        onChat: async function ({ api, event, commandName }) {
                ...
                if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
                        ...
                        const randomReplies = [
                                "babu khuda lagse🥺",
                                "ব্যাডা◻︎আক্তার◻︎বেডি◻︎𝐄𝐯𝐚𝐧◻︎𝐕𝐚𝐢◻︎কে◻︎👌︎□︎𝐁𝐨𝐬𝐬◻︎বল😾🐸",
                                ...
                                "বেশি bby Bbby করলে BOX(0️⃣6️⃣)ꕀ⃘⃜⃟ؖؖؖؖؖؖؖؖؖ◎𝐅𝐫𝐢𝐞𝐧𝐝'sꕥ𝐂𝐥𝐮𝐛ꕀ⃘⃜⃟ؖؖؖؖؖؖؖؖؖMusicꕀ⃘⃜⃟ؖؖؖؖؖ  BAnd থেকে লিট  নিবো কিন্তু 😒😒",
                                "__বেশি বেবি বললে কামুর দিমু 🤭🤭",
                                "𝙏𝙪𝙢𝙖𝙧 𝙜𝙛 𝙣𝙖𝙞, 𝙩𝙖𝙮 𝙖𝙢𝙠 𝙙𝙖𝙠𝙨𝙤? 😂😂😂",
                                "আমাকে ডেকো না,আমি 𝐄𝐯𝐚𝐧 𝐕𝐚𝐢 সাতে টাংকি মারি🙆🏻‍♀",
                                "𝗕𝗯𝘆 বললে চাকরি থাকবে না",
                                "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার বস মানে, 𝐄𝐯𝐚𝐧 আর সাথে তো প্রেম পারো😑?",
